...
describe('global app settings', () => {
  ...
  it('persists supported settings', () => {
    ...
    saveAppSettings({ defaultRealm: 'cn', gameDirectories: { cn: 'F:\\WeGameApps\\rail_apps\\poe2', global: '' }, confirmUnsavedExit: false, uiScalePercent: 125, updateChannel: 'dev', updateCheckIntervalMinutes: 30, proxyDomains: ['https://proxy.example'], priceCheckEnabled: true, priceCheckHotkey: 'Alt+D', analyticsEnabled: true }, storage)
    expect(loadAppSettings(storage)).toEqual({ defaultRealm: 'cn', gameDirectories: { cn: 'F:\\WeGameApps\\rail_apps\\poe2', global: '' }, confirmUnsavedExit: false, uiScalePercent: 125, updateChannel: 'dev', updateCheckIntervalMinutes: 30, proxyDomains: ['https://proxy.example'], priceCheckEnabled: true, priceCheckHotkey: 'Alt+D', analyticsEnabled: true })
  })
  ...
  it('does not fail when persistent storage is unavailable', () => {
    expect(() => saveAppSettings({ defaultRealm: 'global', gameDirectories: { cn: '', global: '' }, confirmUnsavedExit: true, uiScalePercent: 100, updateChannel: 'release', updateCheckIntervalMinutes: 60, proxyDomains: [], priceCheckEnabled: false, priceCheckHotkey: 'Ctrl+D', analyticsEnabled: true }, {
      getItem: () => null,
