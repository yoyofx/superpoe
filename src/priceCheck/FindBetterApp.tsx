...
import { localizedPrice, PRICE_CURRENCY_OPTIONS } from './priceFormatting'
...
export function FindBetterApp() {
  ...
  const comparisonRuneBehavior = state?.findBetterComparison?.runeBehavior || runeBehavior
  const comparisonAnointBehavior = state?.findBetterComparison?.anointBehavior || anointBehavior
