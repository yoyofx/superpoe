...
const strings: Record<Language, Translations> = {
  en: {
    ...
    'equipment.closeDetails': 'Close item details',
    'equipment.copyPob': 'Copy to PoB',
    'equipment.copiedPob': 'Copied',
    'equipment.copyPobFailed': 'Copy failed',
  ...
  'zh-rCN': {
    ...
    'equipment.closeDetails': '关闭装备详情',
    'equipment.copyPob': '复制到 PoB',
    'equipment.copiedPob': '已复制',
    'equipment.copyPobFailed': '复制失败',
  ...
  'zh-rTW': {
    ...
    'equipment.closeDetails': '關閉裝備詳情',
    'equipment.copyPob': '複製到 PoB',
    'equipment.copiedPob': '已複製',
    'equipment.copyPobFailed': '複製失敗',
  ...
  'ko-KR': {
    ...
    'equipment.closeDetails': '아이템 상세 정보 닫기',
    'equipment.copyPob': 'PoB로 복사',
    'equipment.copiedPob': '복사됨',
    'equipment.copyPobFailed': '복사 실패',
