const translations = {
  zh: {
    ...
    download: { title: '下一套构筑，<br /><span>从这里开始。</span>', copy: 'Windows 与 macOS 持续构建。安装后即可离线使用核心计算与构筑管理。', primary: '下载 SuperPoE2 <span>↗</span>', secondary: '查看运行流程 <span>↓</span>' },
  ...
  en: {
    ...
    download: { title: 'Your next build<br /><span>starts here.</span>', copy: 'Windows and macOS builds continue to evolve. Install and keep core calculation and build management offline.', primary: 'Download SuperPoE2 <span>↗</span>', secondary: 'View the workflow <span>↓</span>' },
