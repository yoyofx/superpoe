...
if (dryRun) {
  ...
  console.log('[PLAN] Xiletrade parser rules: node scripts/build_xiletrade_parser_catalog.mjs')
...
run('Xiletrade parser rules', 'node', ['scripts/build_xiletrade_parser_catalog.mjs'])
