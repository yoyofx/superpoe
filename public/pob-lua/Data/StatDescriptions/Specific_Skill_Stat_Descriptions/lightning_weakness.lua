...
return {
	...
	[3]={
		[1]={
			[1]={
				...
				text="Curse inflicts {0:+d}% to Lightning Resistance"
			}
		},
		stats={
	...
	[5]={
		...
		stats={
			[1]="skill_curse_lightning_damage_resistance_%_magnitude_to_apply"
		}
	},
	[6]={
		[1]={
	...
	["base_skill_buff_lightning_damage_resistance_%_to_apply"]=3,
	["base_skill_effect_duration"]=4,
	parent="skill_stat_descriptions",
	["skill_curse_lightning_damage_resistance_%_magnitude_to_apply"]=5,
